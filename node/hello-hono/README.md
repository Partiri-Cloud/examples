...
A minimal Hono application ready to deploy on [Partiri](https://partiri.cloud).
...
2. In the [Partiri dashboard](https://partiri.cloud), click **Create service** and fill in:
   ...
   | Branch | `main` |
   | Root directory | `node/hello-hono` |
...
1. Build and push the image to your own registry:
   ```bash
   docker build -t ghcr.io/<you>/hello-hono:latest .
   docker push ghcr.io/<you>/hello-hono:latest
   ```
2. In the Partiri dashboard, click **Create service** and fill in:
   ...
   | Registry URL | `ghcr.io/<you>/hello-hono:latest` |
