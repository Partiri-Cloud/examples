...
A minimal [Fiber](https://gofiber.io) application ready to deploy on [Partiri](https://partiri.cloud).
...
1. Build and push the image to your own registry:
   ```bash
   docker build -t ghcr.io/<you>/hello-fiber:latest .
   docker push ghcr.io/<you>/hello-fiber:latest
   ```
2. In the Partiri dashboard, click **Create service** and fill in:
   ...
   | Registry URL | `ghcr.io/<you>/hello-fiber:latest` |
