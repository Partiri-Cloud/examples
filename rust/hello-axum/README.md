...
A minimal [Axum](https://github.com/tokio-rs/axum) application ready to deploy on [Partiri](https://partiri.cloud).
...
2. In the [Partiri dashboard](https://partiri.cloud), click **Create service** and fill in:
   ...
   | Branch | `main` |
   | Root directory | `rust/hello-axum` |
   | Build command | `cargo build --release` |
   | Run command | `./target/release/hello-axum` |
...
1. Build and push the image to your own registry:
   ```bash
   docker build -t ghcr.io/<you>/hello-axum:latest .
   docker push ghcr.io/<you>/hello-axum:latest
   ```
2. In the Partiri dashboard, click **Create service** and fill in:
   ...
   | Registry URL | `ghcr.io/<you>/hello-axum:latest` |
